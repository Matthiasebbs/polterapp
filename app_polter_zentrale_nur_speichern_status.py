...
with right:
    ...
    if not edit_view.empty:
        ...
        def edit_polter_form(pid, row):
            with st.form("edit", enter_to_submit=False):
                st.caption("Umrechnung: 1,5 RM = 1 FM. Ändere einfach RM oder FM – das jeweils andere Feld wird erst beim Klick auf „Speichern“ neu berechnet und übernommen.")
